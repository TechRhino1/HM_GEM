...
SYMBOL_PROFILES: Dict[str, SymbolProfileConfig] = {
    ...
    "SOLUSD": SymbolProfileConfig(
        ...
        digits=2,
        typical_spread_pips=45.0,
        max_allowed_spread_pips=80.0,
        commission_per_lot=0.0,
        min_volume=0.05,
        volume_step=0.01,
        margin_pct=0.5
    ...
    "EURUSD": SymbolProfileConfig(
        ...
        strategy_weights={"RANGE_MEAN_REVERSION": 3.8, "CHOCH_STRUCTURAL_REVERSAL": 2.0, "LIQUIDITY_SWEEP_REVERSAL": 1.5, "TREND_PULLBACK": 0.0, "TREND_FOLLOWING": 0.0, "BREAKOUT_EXPANSION": 0.0},
        banned_strategies=["BREAKOUT_EXPANSION", "TREND_FOLLOWING", "TREND_PULLBACK"], sl_atr_multiplier=2.60, min_target_rr=2.0, asym_rr=3.5,
        fast_cash_r=0.50, fast_cash_volume_pct=0.50, be_trigger_r=1.00, runner_trail_atr=2.60,
    ...
    "GBPUSD": SymbolProfileConfig(
        ...
        banned_strategies=["BREAKOUT_EXPANSION", "TREND_FOLLOWING"], sl_atr_multiplier=2.60, min_target_rr=2.0, asym_rr=3.5,
        fast_cash_r=0.50, fast_cash_volume_pct=0.50, be_trigger_r=1.00, runner_trail_atr=2.60,
    ...
    "USDJPY": SymbolProfileConfig(
        ...
        banned_strategies=["BREAKOUT_EXPANSION", "RANGE_MEAN_REVERSION", "TREND_PULLBACK"], sl_atr_multiplier=2.80, min_target_rr=2.0, asym_rr=3.5,
        fast_cash_r=0.50, fast_cash_volume_pct=0.50, be_trigger_r=1.00, runner_trail_atr=2.60,
    ...
    "USDCHF": SymbolProfileConfig(
        ...
        banned_strategies=["BREAKOUT_EXPANSION", "TREND_FOLLOWING", "TREND_PULLBACK", "LIQUIDITY_SWEEP_REVERSAL", "RANGE_MEAN_REVERSION"], sl_atr_multiplier=2.60, min_target_rr=2.0, asym_rr=3.5,
        fast_cash_r=0.50, fast_cash_volume_pct=0.50, be_trigger_r=1.00, runner_trail_atr=2.60,
        session_restriction=True, allowed_utc_hours=(7, 18), contract_size=100_000.0, pip_size=0.0001, pip_value_per_lot=10.0, digits=5,
    ...
    "USDCAD": SymbolProfileConfig(
        ...
        banned_strategies=["BREAKOUT_EXPANSION"], sl_atr_multiplier=2.60, min_target_rr=2.0, asym_rr=3.5,
        fast_cash_r=0.50, fast_cash_volume_pct=0.50, be_trigger_r=1.00, runner_trail_atr=2.60,
    ...
    "EURJPY": SymbolProfileConfig(
        ...
        banned_strategies=["BREAKOUT_EXPANSION", "RANGE_MEAN_REVERSION"], sl_atr_multiplier=2.60, min_target_rr=2.0, asym_rr=3.5,
        fast_cash_r=0.50, fast_cash_volume_pct=0.50, be_trigger_r=1.00, runner_trail_atr=2.60,
        session_restriction=False, contract_size=100_000.0, pip_size=0.01, pip_value_per_lot=6.80, digits=3,
    ...
    "GBPJPY": SymbolProfileConfig(
        ...
        banned_strategies=["BREAKOUT_EXPANSION", "RANGE_MEAN_REVERSION", "LIQUIDITY_SWEEP_REVERSAL"], sl_atr_multiplier=2.60, min_target_rr=2.0, asym_rr=3.5,
        fast_cash_r=0.50, fast_cash_volume_pct=0.50, be_trigger_r=1.00, runner_trail_atr=2.60,
        session_restriction=False, contract_size=100_000.0, pip_size=0.01, pip_value_per_lot=6.80, digits=3,
...
_ALIAS_TO_CANONICAL: Dict[str, str] = {
    "GOLD": "XAUUSD", "GOLD.I#": "XAUUSD", "GOLD.I": "XAUUSD", "GOLD24-7.I#": "XAUUSD", "GOLD24-7#": "XAUUSD", "XAUUSD#": "XAUUSD", "XAUUSD.I#": "XAUUSD", "XAUUSD.I": "XAUUSD",
